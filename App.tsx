...
import { LayoutDashboard, Trophy, Calendar, ClipboardCheck, Settings, Star, Lock, LucideIcon } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const NavItem = ({ id, icon: Icon, label }: { id: ViewState, icon: LucideIcon, label: string }) => (
    <button
      onClick={() => setView(id)}
